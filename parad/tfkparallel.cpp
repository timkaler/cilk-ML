...
wl_stacks::wl_stacks () {
  ...
  gradient_registered_arr = (adept::uIndex*) malloc(
          sizeof(adept::uIndex)*gradient_registered_arr_capacity);
  gradient_unregistered_arr = (adept::uIndex*) malloc(
          sizeof(adept::uIndex)*gradient_unregistered_arr_capacity);

  statement_stack_arr = (adept::internal::Statement*) malloc(
          sizeof(adept::internal::Statement)*statement_stack_arr_capacity);

  statement_stack_deposit_location = (float**) malloc(
          sizeof(float*) * statement_stack_arr_capacity);
  statement_stack_deposit_location_len = (int*) malloc(
          sizeof(int) * statement_stack_arr_capacity);

  operation_stack_deposit_location = (float**) malloc(
          sizeof(float*) * operation_stack_arr_capacity);
  operation_stack_deposit_location_valid = (bool*) malloc(
          sizeof(bool) * operation_stack_arr_capacity);
  ...
  operation_stack_arr = (adept::uIndex*) malloc(
          sizeof(adept::uIndex)*operation_stack_arr_capacity);
  multiplier_stack_arr = (adept::Real*) malloc(
          sizeof(adept::Real)*multiplier_stack_arr_capacity);
}
